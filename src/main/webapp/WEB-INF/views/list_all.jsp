...
<section class="main-banner">
    ...
    <div class="text-overlay">
        <h1 class="banner-title">All Housing Posts</h1>
        <p class="banner-subtitle">전체 게시글을 확인하세요.</p>
    </div>
</section>

<div class="container mt-5 mb-5">
    <form action="${pageContext.request.contextPath}/posts/list/all" method="get" class="d-flex mb-4 ms-auto" style="max-width: 400px;">
