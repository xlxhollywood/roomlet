...
<section class="main-banner">
    ...
    <div class="text-overlay">
        <h1 class="banner-title">Housing Request List</h1>
        <p class="banner-subtitle">양도를 구하는 사람들과 컨택하세요!</p>
    </div>
</section>

<div class="container mt-5">
    <!-- 검색 입력 폼 -->
    <form action="${pageContext.request.contextPath}/posts/list" method="get" class="d-flex mb-4 ms-auto" style="max-width: 400px;">
